  ...
  <div class="main-content">
    ...
    <?php if ($_SESSION['user']['role'] === 'admin'): ?>
      ...
      <div class="menu-section">
        ...
        <div class="menu-grid">
          <a href="<?= url('user/list') ?>" class="menu-item">
          ...
          <a href="<?= url('shift/calendar') ?>" class="menu-item">
            <div class="menu-item-icon">📅</div>
            <div class="menu-item-content">
          ...
          <a href="<?= url('pay/summary') ?>" class="menu-item">
            <div class="menu-item-icon">💰</div>
            <div class="menu-item-content">
          ...
          <a href="<?= url('pay/settings') ?>" class="menu-item">
            <div class="menu-item-icon">🧾</div>
            <div class="menu-item-content">
    ...
    <?php else: ?>
      ...
      <div class="menu-section">
        ...
        <div class="menu-grid">
          <a href="<?= url('shift/view_all') ?>" class="menu-item">
            <div class="menu-item-icon">📋</div>
            <div class="menu-item-content">
          ...
          <a href="<?= url('shift/view_my') ?>" class="menu-item">
            <div class="menu-item-icon">📅</div>
            <div class="menu-item-content">
          ...
          <a href="<?= url('pay/my_pay') ?>" class="menu-item">
            <div class="menu-item-icon">💰</div>
            <div class="menu-item-content">
    ...
    <div class="logout-btn">
      <a href="<?= url('logout') ?>" class="btn btn-outline btn-lg">
        🚪 ログアウト
      </a>
    </div>
  </div>
